...
test-unit:
	go test -v -race -coverprofile=coverage-unit.out -coverpkg=./... ./test/unit-test/...

test-db-integration:
	go test -v -timeout 120s -coverprofile=coverage-db.out -coverpkg=./... ./test/database_integration/...

test-api-integration:
	go test -v -timeout 120s -coverprofile=coverage-api.out -coverpkg=./... ./test/api_integration/...
